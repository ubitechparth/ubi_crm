...
class CountryPickerTwo extends StatefulWidget {
  CountryPickerTwo(
      {super.key,
  ...
  @override
  CountryPickerTwoState createState() => CountryPickerTwoState();
}

// Country picker state class
class CountryPickerTwoState extends State<CountryPickerTwo> {
  ...
  Future<void> showDialogue(context) async {
    ...
    if (countryData != null) {
      ...
      sDialCode = countryData.dialCode;
    }
    setState(() {});
  }
}
