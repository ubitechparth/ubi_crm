  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        leading: InkWell(onTap: (){Get.back();}, child: AppIcons.arrowBackIcon(color: AppColor.whiteOriginalColor)),
        actions: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
               color: Colors.white,
                boxShadow: [
                  BoxShadow(
                    color: AppColor.primaryOriginalColor.withOpacity(0.2), // Shadow color
...
SizedBox(height: 20,),
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                     children: [
                       Column(
                         ...
                         children: [
                           Text("Regendra Suman",style: AppTextStyle.bodyText6B(color: AppColor.primaryDarkColor),),
                           Text("regendrasuman@ubitechsolutions.com",style: AppTextStyle.bodyText4M(color: AppColor.grayDarkerColor),),
                           Text("7566790833",style: AppTextStyle.bodyText4M(color: AppColor.grayDarkerColor),),
                           Text("Attendance, Payroll, Leave",style: AppTextStyle.bodyText4M(color: AppColor.grayDarkerColor),),
                         ],
                       ),
                       CircleAvatar(
                   ...
                   children: [
                     ...
                     Row(
                       children: [
                         ...
                         SizedBox(width: 10,),
                         Text("75%",style: AppTextStyle.bodyText6B(),),
                       ],
                     ),
                   ],
                 )
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Lead Owner",style: AppTextStyle.bodyText6B(),),
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: 6,),
                                Text("Regendra Suman",style: AppTextStyle.bodyText6B(),),
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  SvgPicture.asset(AppAssets.svg.fileTextImage,),
                                  SizedBox(width: 8,),
                                  Text("Notes",style: AppTextStyle.bodyText5B(),),
                        ...
                        SizedBox(height: 8,),
                        Text('High chances of getting finallized. Good Client 😀 ',style: AppTextStyle.bodyText4SB(color: AppColor.grayDarkerColor),),
                      ],
                    ),
                  ),
                ),
